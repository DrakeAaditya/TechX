...
<html lang="">
<head>
<title>TechnologyXpress | Gallery</title>
<meta charset="utf-8">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content"> 
      ...
      <div id="gallery">
        <figure>
          <header class="heading">Technology</header>
          <ul class="nospace clear">
            <li class="one_quarter first"><img src="/images/demo/gallery/13.png" alt=""></li>
            ...
            <li class="one_quarter first"><a href="#"><img src="/images/demo/gallery/11.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/05.png" alt=""></a></li>
            ...
            <li class="one_quarter first"><a href="#"><img src="/images/demo/gallery/12.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/08.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/09.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/10.png" alt=""></a></li>
            <li class="one_quarter first"><img src="/images/demo/gallery/01.jpg" alt=""></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/14.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/15.png" alt=""></a></li>
            <li class="one_quarter"><a href="#"><img src="/images/demo/gallery/16.png" alt=""></a></li>
          </ul>
          <figcaption>It's all about Inventions</figcaption>
        </figure>
      </div>
      <!-- ################################################################################################ -->
      <!-- ################################################################################################ -->
